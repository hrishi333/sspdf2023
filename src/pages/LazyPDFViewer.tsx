...
const HomePage: React.FC = () => {
    ...
    const getUserFromSessionStorage = (): UserData | null => {
        ...
        <Background color="bg-gray-100">
            <Section yPadding="py-6">
                <NavbarTwoColumns logo={<Logo xl />}>
                    ...
                    {storedUser?.uid ? (
                        <li className="cursor-pointer hover:bg-black hover:text-white p-2 rounded" onClick={handleLogout}>
                            Logout
                        </li>
                    ) : (
                        <li className="cursor-pointer hover:bg-black hover:text-white p-2 rounded">Sign In</li>
                    )}
                </NavbarTwoColumns>
            </Section>
